...
///////////////////////////////////////////////////////////////////////
  const handleLangFilterChange = (e,filterType) => {
    switch(filterType) {
  ...
  // if()   filteredUsers = users.filter( user => user.languages.some(({ langue }) => langue === langFilter));
    ...
    return array.filter((item) => {
      ...
      useEffect (  () => {
        ...
        if  (langFilter !==''){   
          ...
          filteredUsers = users.filter( user => user.city === cityFilter.name)
        }
        else{}
 ...
 console.log("cityFilter",cityFilter,"user.city");
/*
...
*/
    ...
    //: OR (NO there is No filter users)
       ...
       return (
        ...
        <Select name="langFilter" id="langFilter"  value='' labelId="langFilter-label" onChange={(e) => handleLangFilterChange(e,"langFilter")} >
